...
$expected = array('Julia U.'=>'julia-upiterskaya','Julia Yupiterskaya'=>'julia-upiterskaya','Julia Upiterskaya'=>'julia-upiterskaya','Alina B.'=>'alina-b','Alina K.'=>'alina-b','Anonymous'=>'editorial-team','Editorial Team'=>'editorial-team');
...
$identityConflict=$correct; $identityConflict[]=array('id'=>99,'slug'=>'julia-upiterskaya-duplicate','name'=>'Julia Upiterskaya','post_type'=>'rev_author','status'=>'publish','schema_type'=>'person','same_as'=>wp_json_encode(array('https://www.linkedin.com/in/julia-upiter/'))); check(1===revelations_author_migration_plan_provision($identityConflict)['summary']['conflicts'], 'duplicate canonical identity blocks provisioning');
...
$targets=array('julia-upiterskaya'=>10,'alina-b'=>11,'editorial-team'=>12); $fixture=array();
...
check(53===$plan['summary']['total_inspected'] && 53===$plan['summary']['pending_writes'] && array('alina-b'=>31,'editorial-team'=>7,'julia-upiterskaya'=>15)===$plan['summary']['canonical_targets'], 'known 53 article fixture plans exact canonical totals');
