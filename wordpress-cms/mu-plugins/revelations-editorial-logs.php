...
function revelations_editorial_create_run_log(
    ...
    $defaults = array(
        ...
        'stage_usage' => array(),
        'context_sizes' => array(),
        'research_source_registry_summary' => array(),
    ...
    $meta = array(
        ...
        '_rev_research_source_registry_summary' => wp_json_encode( is_array( $data['research_source_registry_summary'] ) ? $data['research_source_registry_summary'] : array(), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE ),
...
function revelations_editorial_log_ai_generation(
    ...
    return revelations_editorial_create_run_log(
        array(
            ...
            'research_source_registry_summary' => is_array( $result['research_source_registry_summary'] ?? null ) ? $result['research_source_registry_summary'] : array(),
