...
import { selectLiveArticleCatalog } from '@/lib/article-catalog-policy';
...
export async function getPublishedArticles() {
  if (!CMS_API_URL) {
    return selectLiveArticleCatalog({
      cmsConfigured: false,
      cmsArticles: [],
      legacyArticles: getLegacyArticles(),
    });
  }

  return selectLiveArticleCatalog({
    cmsConfigured: true,
    cmsArticles: await fetchCmsArticles(),
    legacyArticles: [],
  });
}
